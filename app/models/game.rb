class Game < ApplicationRecord
    ...
    validates :homeTeamName, presence: true, inclusion: { in: nbaTeams, message: "%{value} is not a valid team" }
    validates :awayTeamName, presence: true, inclusion: { in: nbaTeams, message: "%{value} is not a valid team" }
